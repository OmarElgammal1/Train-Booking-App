...
output_path = "C:\\Users\\youse\\Documents\\GitHub\\DB-Project\\GUI\\report\\RailScapeSummaryReport.pdf"
...
def generateReport(cursor):
    ...
    # Load fonts
    pdfmetrics.registerFont(TTFont("Arial", "C:\\Users\\youse\\Documents\\GitHub\\DB-Project\\GUI\\report\\arial.ttf"))
    pdfmetrics.registerFont(TTFont("Arial-Bold", "C:\\Users\\youse\\Documents\\GitHub\\DB-Project\\GUI\\report\\arial-bold.ttf"))
